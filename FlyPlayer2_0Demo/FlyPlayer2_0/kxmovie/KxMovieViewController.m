                ...
                parameters: (NSDictionary *) parameters
{
    ...
    if (self) {
#pragma mark - 创建goTimeLabel
        
        goTimeLabel= [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 80, 40)];
        goTimeLabel.layer.cornerRadius=10;
        goTimeLabel.layer.masksToBounds=YES;
        goTimeLabel.textColor=[UIColor colorWithWhite:0.3 alpha:0.9];
        goTimeLabel.backgroundColor=[UIColor colorWithWhite:1 alpha:0.5];
        goTimeLabel.hidden=YES;
        goTimeLabel.font=[UIFont systemFontOfSize:16];
        goTimeLabel.textAlignment=UIAlertActionStyleCancel;
        goTimeLabel.layer.shadowOffset=CGSizeMake(0, 3);
        goTimeLabel.layer.shadowRadius = 5.0;
        goTimeLabel.layer.shadowColor = [UIColor blackColor].CGColor;
        goTimeLabel.layer.shadowOpacity=0.5;
        _moviePosition = 0;
...
//        _topHUD.frame = CGRectMake(10,100,width-20,300);
...
//    _glView
    ...
    UISwipeGestureRecognizer * swipeGestureWithLeft = [[UISwipeGestureRecognizer alloc]initWithTarget:self action:@selector(swipeGestureWithLeftAction:)];
    

    swipeGestureWithLeft.direction = UISwipeGestureRecognizerDirectionLeft;

    [_glView addGestureRecognizer:swipeGestureWithLeft];
    
    
    
    UISwipeGestureRecognizer * swipeGestureWithRight = [[UISwipeGestureRecognizer alloc]initWithTarget:self action:@selector(swipeGestureWithRightAction:)];
    
    swipeGestureWithRight.direction = UISwipeGestureRecognizerDirectionRight;

    [_glView addGestureRecognizer:swipeGestureWithRight];
...
#pragma mark -左滑动后退
-(void)swipeGestureWithLeftAction:(UISwipeGestureRecognizer*)swip
{
    
    goTimeLabel.center=_glView.center;
    [_glView addSubview:goTimeLabel];
    goTimeLabel.text=@"后退15秒";
    goTimeLabel.hidden=NO;
    [self performSelector:@selector(clickGotimeHiden) withObject:nil afterDelay:0.5];
    
    [self setMoviePosition: _moviePosition - 15];
    
}
-(void)clickGotimeHiden
{
    goTimeLabel.hidden=YES;
...
#pragma mark -右滑动前进
-(void)swipeGestureWithRightAction:(UISwipeGestureRecognizer *)swipe
{
    goTimeLabel.center=_glView.center;
    [_glView addSubview:goTimeLabel];
    
    goTimeLabel.text=@"前进15秒";
    goTimeLabel.hidden=NO;
